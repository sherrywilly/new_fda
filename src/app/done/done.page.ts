 ...
 intrr:any;
  ...
  async loadMap(dboy) {
    ...
    this.geolocation.getCurrentPosition().then((resp) => {
      ...
      this.startNavigating(dboy.lat, dboy.lng);

      this.getAddressFromCoords(dboy.lat, dboy.lng);
  ...
  startNavigating(lat,lng){
        ...
        destination: {lat: parseFloat(this.data.lat), lng: parseFloat(this.data.lng)},
